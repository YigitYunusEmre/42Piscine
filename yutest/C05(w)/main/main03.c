...
int	main(void)
{
	...
	result = ft_recursive_power(1498, 0);
	printf("Expected: 1\n");
	printf("Got: %d\n", result);
	if (result == 1)
	{
	...
	result = ft_recursive_power(-2938, 1);
